...
//    case updateUserDataWithImage(params: [String: Any], imageFiles: [(Data, String)]?, token: String)
    ...
    case editPhone(params: [String: Any], token: String)
    case searchFreelancers(params: [String: Any], token: String)
    ...
    var path: String {
        ...
        case .editPhone:
            return "/mobile/user/update-phone"
        case .searchFreelancers:
            return "/mobile/home/search"
        }
    }
